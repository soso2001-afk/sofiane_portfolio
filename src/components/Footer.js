  ...
  return (
    <div className="mt-4 bg-dark-200 rounded-md text-white px-8 py-4">
      <ul className="text-center">
        <li><a href="#home" className="hover:underline">À propos</a></li>
        <li><a href="#skills" className="hover:underline">Compétences</a></li>
        <li><a href="#honors" className="hover:underline">Projets académiques & stages</a></li>
      ...
      <p className="text-sm font-light text-center">Copyright © 2023 MAHMOUDI Sofiane . All Right Reserved</p>
